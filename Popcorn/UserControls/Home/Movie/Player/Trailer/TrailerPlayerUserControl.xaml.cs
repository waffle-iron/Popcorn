...
namespace Popcorn.UserControls.Home.Movie.Player.Trailer
{
    /// <summary>
    /// Interaction logic for MoviePlayer.xaml
    /// </summary>
    public partial class TrailerPlayerUserControl : IDisposable
    {
        /// <summary>
        ...
        internal static readonly DependencyProperty VolumeProperty = DependencyProperty.Register("Volume", typeof (int),
            typeof (TrailerPlayerUserControl), new PropertyMetadata(100, OnVolumeChanged));

        private bool _isMouseActivityCaptured;

        /// <summary>
        /// Initializes a new instance of the MovieTrailerPlayer class.
        /// </summary>
        public TrailerPlayerUserControl()
        {
            InitializeComponent();
            Loaded += OnLoaded;
        }
        ...
        private void OnLoaded(object sender, EventArgs e)
        {
            ...
            var vm = DataContext as MovieTrailerPlayerViewModel;
            if (vm == null) return;
        ...
        {
            var moviePlayer = obj as TrailerPlayerUserControl;
            if (moviePlayer == null)
                return;
        ...
        /// <param name="sender">Sender object</param>
        /// <param name="e">EventArgs</param>
        private void MediaPlayerEndReached(object sender, Meta.Vlc.ObjectEventArgs<Meta.Vlc.Interop.Media.MediaState> e)
